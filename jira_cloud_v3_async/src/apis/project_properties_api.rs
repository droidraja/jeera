...
pub async fn delete_project_property(configuration: &configuration::Configuration, project_id_or_key: &str, property_key: &str) -> Result<(), Error<DeleteProjectPropertyError>> {
    ...
    let local_var_uri_str = format!("{}/rest/api/3/project/{projectIdOrKey}/properties/{propertyKey}", local_var_configuration.base_path, projectIdOrKey=crate::apis::urlencode(project_id_or_key), propertyKey=crate::apis::urlencode(property_key));
...
pub async fn get_project_property_keys(configuration: &configuration::Configuration, project_id_or_key: &str) -> Result<models::PropertyKeys, Error<GetProjectPropertyKeysError>> {
    ...
    let local_var_uri_str = format!("{}/rest/api/3/project/{projectIdOrKey}/properties", local_var_configuration.base_path, projectIdOrKey=crate::apis::urlencode(project_id_or_key));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
