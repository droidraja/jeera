...
pub struct JiraIssueFields {
    ...
    #[serde(rename = "originalEstimateField", skip_serializing_if = "Option::is_none")]
    pub original_estimate_field: Option<Box<models::JiraDurationField>>,
    ...
    #[serde(rename = "timeTrackingField", skip_serializing_if = "Option::is_none")]
    pub time_tracking_field: Option<Box<models::JiraTimeTrackingField>>,
